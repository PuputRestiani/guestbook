...
<head>
    ...
    <style>
        .btn-small {
            padding: 0.25rem 0.5rem; /* Mengatur padding tombol */
            font-size: 0.875rem; /* Mengatur ukuran font */
        }
    </style>
</head>
        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>
                            Silahkan masukan data kamu sebagai tamu, pada form di bawah:
                        </p>
                        ...
                        <form action="{{ route('form.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="institutions_id" class="form-select @error('institutions_id') is-invalid @enderror">
                                            @foreach ($institutions as $item)
                                                <option value="{{ $item->id }}" @if (old('institutions_id') == $item->id) selected @endif>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phonenumber" id="phonenumber" value="{{ old('phonenumber') }}"
                                    class="form-control @error('phonenumber') is-invalid @enderror" minlength="10" required>
                            ...
                            <button type="submit" class="btn btn-primary btn-small">Submit
